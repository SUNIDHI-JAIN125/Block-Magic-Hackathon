...
const AddLiquidityModal = () => {
    const { modalChoices, setModalChoices, addLiquidity } = useContext(AppContext);
        ...
        <div className='fixed grid h-screen z-20 bg-[#7f777790] place-items-center w-full backdrop-blur-sm'>
            <div className='bg-gradient-to-tl from-primary-background to-primary-background w-[400px] h-[320px] rounded-lg text-white shadow-2xl'>
                ...
                <div className='flex justify-between px-4 space-x-4 font-poppins text-white'>
                    <select name="baseToken" className='bg-transparent border border-white py-2 px-3 w-1/2 rounded-lg text-white font-semibold shadow-2xl' onChange={handleOnChange}>
                    ...
                    <select name="quoteToken" className='bg-transparent border py-2 px-3 w-1/2 rounded-lg text-white font-semibold shadow-2xl' onChange={handleOnChange}>
                ...
                <div className='my-2 px-4 font-poppins text-white'>
                    <div className='py-3 px-2 bg-transparent shadow-2xl rounded-lg flex items-center justify-between'>
                        ...
                        <input type="number" name="baseTokenAmount" min="0" className='border-1 py-1 px-2 text-white w-3/4 bg-transparent outline-none' placeholder='Enter Amount' onChange={handleOnChange} />
                    </div>
                </div>
                <div className='my-2 px-4 font-poppins'>
                    <div className='py-3 px-2 bg-transparent shadow-2xl rounded-lg flex items-center justify-between'>
                        <p className='text-white font-semibold'>{formData.quoteToken}</p>
                        <input type="number" name="quoteTokenAmount" min="0" className='border-1 py-1 px-2 text-white w-3/4 bg-transparent outline-none' placeholder='Enter Amount' onChange={handleOnChange} />
                    </div>
                </div>
                <div className='px-4'>
