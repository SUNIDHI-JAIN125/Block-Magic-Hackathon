    ...
    <div className='flex flex-col bg-primary h-screen py-8  overflow-y-auto min-h-screen border-r border-gray-500'>
        <div className='flex flex-col mx-auto'>
                ...
                <div className='flex space-x-1 font-poppins  mx-auto'>
                    ...
                    <div>
                        <p className='font-semibold text-[13px] mt-1'>Uimega Agency</p>
                        <p className='text-[10px]'>@uimega</p>
                    </div>
                    
                </div>
             <div className='mt-5 ml-2'>
                <div className=''>
                        <h1 className='text-[10px] font-semibold font-poppins my-4'>GENERAL</h1> 
                ...
                <div className=''>
                        <h1 className='text-[10px] font-semibold font-poppins my-4'>MARKETPLACE</h1> 
                ...
                <div className=''>
                        <h1 className='text-[10px] font-semibold font-poppins my-4'>PROFILE</h1> 
             ...
             <div className='h-[100px] bg-primary-button rounded-lg flex flex-col justify-center items-center font-poppins font-semibold text-[10px] mt-5'>
              <p>Great perks for</p>
              <p>NFT hodlers.</p>
