    ...
    <div className='flex flex-col bg-primary h-screen py-8  overflow-y-auto min-h-screen border-r border-gray-500'>
        <div className='flex flex-col mx-auto'>
                ...
                <div className='flex space-x-1 font-poppins  mx-auto'>
                    ...
                    <div>
                        <p className='font-semibold text-[13px] mt-1 text-white'>NFT AMM</p>
                        <p className='text-[10px] text-white'>@ringle</p>
                    </div>
                    
                </div>
             <div className='mt-5 ml-2'>
                <div className=''>
                        <h1 className='text-[10px] font-semibold font-poppins my-4 text-xl text-white'>EXPLORE</h1> 
