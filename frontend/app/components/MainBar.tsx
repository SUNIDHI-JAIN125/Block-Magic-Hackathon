    ...
    <div className='bg-primary-background h-screen py-4 px-4 overflow-y-scroll'>
      ...
      <div className='rounded-lg shadow-lg bg-gradient-to-r from-primary-blend to-primary-background  mt-4 flex flex-1'>
        ...
        <div className='mr-5 mt-5 flex-[0.5]'>
          <p className={`${isConnected ? 'text-[50px]': 'text-[80px]'}  font-semibold font-poppins`}>XterioMask NFT</p>
          ...
          <div className='flex space-x-4'>
            <div className='flex justify-between space-x-4'>
              ...
              <div className='flex flex-col mt-2'>
                ...
                <p className='text-[10px] font-semibold'>Layer Lab</p>
              </div>
            </div>
            <div className='flex justify-between space-x-4'>
              <Image src={nft} alt='' className='w-[50px] h-[50px] rounded-full border border-gray-400' />
              <div className='flex flex-col mt-2'>
                ...
                <p className='text-[10px] font-semibold'>Xter Lab</p>
              </div>
            </div>
          </div>
          <div className='mt-5 flex space-x-4'>
            <button className='px-4 py-2 bg-primary-button font-poppins text-[10px] rounded-sm font-semibold'>Place A Bid</button>
            <button className='px-4 py-2 bg-primary font-poppins text-[10px] rounded-sm font-semibold border-[1px]'>View Item</button>
          </div>
        </div>
